...
test('preview throttles simulation, reuses canvas storage, and hides immediately',()=>{
    ...
    const ctx={clearRect(){clears++;},setLineDash(){},beginPath(){},moveTo(){},lineTo(){},stroke(){},fillText(){}};
    ...
    const context=vm.createContext({game,me,state,window,position,angleFromMouse,getTeam:()=>1,performance:{now:()=>now},unsafeWindow:{throwable:{frag:{fuseTime:4}},objects:{}},document:{createElement:()=>canvas,body:{append(){}}},previewThrow(){simulations++;return {points:[{x:0,y:0},{x:10,y:0}],end:{x:10,y:0}};}});
