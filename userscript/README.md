...
- Throw preview: draws an estimated ground-plane path, full-fuse blast radius and moving-target marker. Uses throw strength, gravity, inherited player movement and dry-ground drag. Passes through destructible windows with at most one estimated health remaining and stops at surviving cover, including reinforced windows. Updates at 20 Hz, reuses the canvas, and filters distant obstacles before the 60 Hz physics simulation. Cooking, water, perks, bounce trajectories and special throwable behavior are not simulated; use it as an estimate. It does not automatically throw.
