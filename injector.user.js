...
(function () {
    ...
    function incomingShotTime(bullet, center, radius=1) {
    ...
    function selectPanDefense(game,state,teamOf) {
    ...
    function activePanDefense(game,state) {
